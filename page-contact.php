...
<?php if( have_posts() ) : while( have_posts() ) : the_post(); ?>
	<div id="contact">
		<header style="background-image: url(<?php echo get_template_directory_uri(); ?>/img/hugo2bsedit.jpg)">
			<div class="content">
				<?php the_content(); ?>	
			</div>
		</header>
		<section class="contact-section">
				<div class="details column col-2-5">
					<div class="detail">
